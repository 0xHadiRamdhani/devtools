...
export function Sidebar() {
    ...
    return (
        <aside className="fixed left-0 top-0 z-40 h-screen w-64 border-r border-white/5 bg-zinc-950/50 backdrop-blur-xl">
            <div className="flex h-full flex-col px-4 py-8">
                ...
                <div className="mt-auto px-2">
                    <div className="rounded-xl border border-white/5 bg-gradient-to-br from-zinc-900 to-zinc-950 p-4">
